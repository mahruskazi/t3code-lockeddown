      ...
      [
        ...
        environment(
          ...
          summary(
            ...
            // [fork:pi] Below the compatibility floor, not a fixed offset from
            // the current version: the fork carries an extra provider bump, so
            // `USAGE_CONTRACT_VERSION - 2` is still mergeable here.
