    ...
    execute: () =>
      sql`
        SELECT
          ...
          pending_rewind_summary AS "pendingRewindSummary",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                pendingRewindSummary: row.pendingRewindSummary ?? null,
                deletedAt: row.deletedAt,
  ...
  const getThreadDetailByIdBounded = (threadId: ThreadId, bounds: ThreadDetailBounds | undefined) =>
    Effect.gen(function* () {
      ...
      const thread = {
        ...
        pinOrderKey: threadRow.value.pinOrderKey ?? null,
        titleRegeneration: mapTitleRegeneration(threadRow.value),
        pendingRewindSummary: threadRow.value.pendingRewindSummary ?? null,
        deletedAt: null,
